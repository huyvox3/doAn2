        ...
        <div class="col-xl-3 col-sm-6 grid-margin stretch-card">
          <div class="card">
            <div class="card-body">
              ...
              </div> <h6 class="text-muted font-weight-normal">Total  Revenue</h6>
            </div>
          </div>
        </div>
        ...
        <div class="col-xl-3 col-sm-6 grid-margin stretch-card">
          <div class="card">
            <div class="card-body">
              ...
              </div> <h6 class="text-muted font-weight-normal">Order  Delivery</h6>
            </div>
          </div>
        </div>
        ...
        <div class="col-xl-3 col-sm-6 grid-margin stretch-card">
          <div class="card">
            <div class="card-body">
              ...
              </div> <h6 class="text-muted font-weight-normal">Order  Processing</h6>
            </div>
          </div>
        </div>
